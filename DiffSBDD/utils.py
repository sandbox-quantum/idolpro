...
def get_pocket_from_sdf(pdb_model, ligand_sdf, dist_cutoff=8.0, use_com=False):
    mol = SDMolSupplier(ligand_sdf)[0]
    ligand_coords = torch.from_numpy(mol.GetConformer().GetPositions()).float()
